// Icons — simple stroke icons (24px)
const Icon = {
  Grid: (p) => (
  ...
  Star: (p) => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
      <polygon points="12 2.5 14.85 8.5 21.5 9.4 16.7 13.95 17.95 20.5 12 17.35 6.05 20.5 7.3 13.95 2.5 9.4 9.15 8.5" />
    </svg>
  ),
  StarFilled: (p) => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
      <polygon points="12 2.5 14.85 8.5 21.5 9.4 16.7 13.95 17.95 20.5 12 17.35 6.05 20.5 7.3 13.95 2.5 9.4 9.15 8.5" />
    </svg>
  ),
  Folder: (p) => (
